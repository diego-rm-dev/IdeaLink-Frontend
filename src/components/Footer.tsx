...
const Footer = () => {
  ...
  return (
    <footer className="bg-idea-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-gray-400 max-w-md">
              IdeaLink is the premier marketplace for buying, selling, and investing in entrepreneurial ideas, powered by advanced AI insights.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {year} IdeaLink. All rights reserved.
          </p>
